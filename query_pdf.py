...
# # Step 1: Prompt template that also requests PDF name
# pdf_template_str = """You are a helpful assistant.
# Use the provided PDF content and file names to answer the user's question.
# Be as detailed as possible, but do not make up any information not in the context.
# If the answer is not in the context, say "I don't know."

# For each part of your answer, include the PDF file name it came from.

# Context:
# {context}
# """

# pdf_system_prompt = SystemMessagePromptTemplate(
#     prompt=PromptTemplate(
#         input_variables=["context"],
#         template=pdf_template_str,
#     )
# )

# pdf_human_prompt = HumanMessagePromptTemplate(
#     prompt=PromptTemplate(
#         input_variables=["question"],
#         template="{question}",
#     )
...
# messages = [pdf_system_prompt, pdf_human_prompt]
# pdf_prompt_template = ChatPromptTemplate(
#     input_variables=["context", "question"],
#     messages=messages,
# )
...
#     embedding_function=OpenAIEmbeddings()
# )
# pdf_retriever = pdf_vector_db.as_retriever(k=2)
...
# ############################## Run Chain in Loop #############################################
# print("💬 PDF Q&A Chat - Press Ctrl+C to exit\n")
